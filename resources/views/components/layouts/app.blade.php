        ...
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            @else
              <flux:dropdown position="top" align="end">
                ...
                <flux:menu>
                    <flux:menu.radio.group>
                        <flux:menu.item :href="route('login')" icon="" wire:navigate>{{ __('Log In') }}</flux:menu.item>
                        <flux:menu.item :href="route('register')" icon="" wire:navigate>{{ __('Register') }}</flux:menu.item>
                    </flux:menu.radio.group>
                </flux:menu>
            </flux:dropdown>
